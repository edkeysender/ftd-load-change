...
echo "    copy deploy/install-agent.ps1 next to the exe and, in an elevated PowerShell,"
echo "    run:  powershell -ExecutionPolicy Bypass -File install-agent.ps1"
echo "    (For a quick unelevated test instead:  .\\simagent.exe)"
